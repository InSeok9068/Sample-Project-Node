...
const byNameAgeRememberMe = concatAll(SemigroupOrdUser)(byName)([byAge, byRememberMe]);
...
const byRememberMeNameAge = concatAll(SemigroupOrdUser)(O.reverse(byRememberMe))([byName, byAge]);
