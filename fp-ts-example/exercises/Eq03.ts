...
assert.deepStrictEqual(eqClock.equals(fromHourMin(0, 0), fromHourMin(24, 0)), true);
assert.deepStrictEqual(eqClock.equals(fromHourMin(12, 30), fromHourMin(36, 30)), true);
